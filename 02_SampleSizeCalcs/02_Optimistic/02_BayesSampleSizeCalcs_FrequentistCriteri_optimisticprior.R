...
#####################################
### Bayesian Sample Size Calculations - Using Frequentist Operating Characteristics - Optimisitc Analysis Prior
#####################################
...
outpath = path(getwd(),"03_Output",ext="") # define output path folder,make sure sub-folder exists
output_name = "BayesSampleSizeCalcs_freqCritOpsstat_N1000_optimisitcprior.RData"
...
benchmarking_optimistic.mod <- stan_model(file = path(getwd(),"02_SampleSizeCalcs","02_Optimistic","02_benchmarking_optimistic.stan",ext=""))   ## C++ Compilation
...
# save and exit 
save.image(file=path(outpath,"01_SampleSizeCalcs","00_Rdata",output_name,ext=""))

write.csv(type1err,file=path(outpath,"01_SampleSizeCalcs","02_Type1Err","type1err_optimistic.csv",ext=""))
write.csv(freq_power,file=path(outpath,"01_SampleSizeCalcs","01_Power","power_optimistic.csv",ext=""))

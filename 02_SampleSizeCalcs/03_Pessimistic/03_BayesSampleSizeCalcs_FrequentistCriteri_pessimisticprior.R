...
#####################################
### Bayesian Sample Size Calculations - Using Frequentist Operating Characteristics - Pessimistic Analysis Prior
#####################################
...
output_name = "BayesSampleSizeCalcs_freqCritOpsstat_N1000_pessimmisticprior.RData"
...
# Analysis Priors: see stan model
...
benchmarking_pessimistic.mod <- stan_model(file = path(getwd(),"02_SampleSizeCalcs","03_Pessimistic","03_benchmarking_pessimistic.stan",ext=""))   ## C++ Compilation
...
write.csv(type1err,file=path(outpath,"02_Type1Err","type1err_pessimistic.csv",ext=""))
write.csv(freq_power,file=path(outpath,"01_Power","power_pessimistic.csv",ext=""))
